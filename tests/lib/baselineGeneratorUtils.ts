...
type BaselineGeneratorFunction = (typeChecker: ts.TypeChecker, sourceFile: ts.SourceFile, node: ts.Node) => string|undefined

export function typeBaselineGenerator(generator: (typeChecker: ts.TypeChecker, sourceFile: ts.SourceFile, type: ts.Type, symbol: ts.Symbol, node: ts.Node) => string|undefined): BaselineGeneratorFunction {
...
export function symbolBaselineGenerator(generator: (typeChecker: ts.TypeChecker, sourceFile: ts.SourceFile, symbol: ts.Symbol, node: ts.Node) => string|undefined): BaselineGeneratorFunction {
...
export function generateBaseline(generator: BaselineGeneratorFunction, sourceFile: ts.SourceFile, typeChecker: ts.TypeChecker) {
    return sourceFile
        .getChildren()[0]!
        .getChildren()
