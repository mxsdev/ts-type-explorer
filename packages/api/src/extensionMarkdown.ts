...
import { ExtensionMarkdown } from './types'
...
export function addMarkdownDocumentation(
    ...
    if (documentation) {
        ...
        out.push({type: 'markdown', content: plainWithLinks(documentation, converter)})
    }
